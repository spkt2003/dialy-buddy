        ...
        <div className="bg-surface-container-lowest rounded-[2rem] p-8 md:p-16 flex flex-col md:flex-row items-center gap-12 overflow-hidden relative shadow-ambient ghost-border">
          <div className="md:w-1/2 space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 py-4">
              ...
              <span className="text-4xl sm:text-6xl font-extrabold font-headline text-primary">17.6%</span>
              <span className="text-base sm:text-xl text-on-surface-variant font-medium font-body mt-2">ของประชากรไทย</span>
            </div>
          </div>
          <div className="md:w-1/2 relative flex justify-center">
            <div className="w-52 h-52 sm:w-64 sm:h-64 md:w-72 md:h-72 rounded-full border-[12px] sm:border-[16px] border-surface-container-high relative flex items-center justify-center">
              <div className="absolute inset-0 rounded-full border-[12px] sm:border-[16px] border-primary" style={{ clipPath: 'polygon(50% 50%, 50% 0%, 100% 0%, 100% 100%, 0% 100%, 0% 0%, 17.6% 0%)' }}></div>
              <div className="text-center">
                <p className="text-3xl sm:text-4xl font-extrabold font-headline text-on-background">11.6 ล้าน</p>
