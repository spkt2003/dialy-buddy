    ...
    <section className="bg-background py-20 md:py-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="mb-6 text-3xl sm:text-5xl md:text-7xl font-extrabold font-headline leading-[1.1] tracking-tight text-on-background">
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              href="/find-buddy"
              className="bg-primary text-on-primary px-8 py-4 rounded-xl text-lg font-bold shadow-ambient hover:brightness-105 active:scale-95 duration-200 ease-in-out flex items-center justify-center gap-2 font-label"
            >
              ค้นหาผู้ดูแล
